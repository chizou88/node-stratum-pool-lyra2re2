    ...
    function DetectCoinData(finishedCallback){
        ...
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            if (!options.coin.reward) {
                ...
                } else (isNaN(rpcResults.getdifficulty) && 'proof-of-stake' in rpcResults.getdifficulty){
            ...
            if (coin == 'neetcoin') {
                options.initStats = {
                    ...
                    difficulty: rpcResults.getinfo.response.difficulty['proof-of-work'] * algos[options.coin.algorithm].multiplier,
                    networkHashRate: + rpcResults.getmininginfo.response.netmhashps * 1000
            } else {
                options.initStats = {
                    connections: rpcResults.getinfo.connections,
